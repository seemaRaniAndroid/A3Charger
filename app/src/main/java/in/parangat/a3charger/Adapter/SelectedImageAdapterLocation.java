...
public class SelectedImageAdapterLocation extends RecyclerView.Adapter<SelectedImageAdapterLocation.ViewHolder> {
    private final static String FOLDER = Environment.getExternalStorageDirectory() + "/PDF";
    private final ArrayList<Uri> mImageUriList;
    private Context mContext;
    //  private boolean isUriType = true;

    public SelectedImageAdapterLocation(ArrayList<Uri> mImageUriList, Context mContext) {
...
*/
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        try {
            if (mImageUriList.get(position).toString().contains("png") || mImageUriList.get(position).toString().contains("jpg") || mImageUriList.get(position).toString().contains("jpeg")) {
                Glide.with(mContext).load(mImageUriList.get(position).toString()).into(holder.row_image);
            } else {
