...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatImageView label1) {
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.label_1;
      AppCompatImageView label1 = ViewBindings.findChildViewById(rootView, id);
      if (label1 == null) {
        break missingId;
      }

      return new ActivitySplashBinding((ConstraintLayout) rootView, label1);
    }
